...
set pkg_name=eigen-%version%
set pkg_file=%pkg_name%.zip
set src_dir=%work_dir%\%pkg_name%
set build_dir=%work_dir%\build
set install_dir=D:\Library\libeigen
set boost_cmake_dir=D:\Library\libboost\lib\cmake\Boost-1.80.0
...
cmake -G%cmake_gen_type% -A%cmake_gen_arch% -S. -B%build_dir% -DCMAKE_INSTALL_PREFIX=%install_dir% ^
    -DCMAKE_BUILD_TYPE=Release -DEIGEN_TEST_CXX11=ON -DBoost_DIR=%boost_cmake_dir%
