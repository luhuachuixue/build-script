...
set pkg_name=happytime-gb28181-device-code
set pkg_file=%pkg_name%.zip
set src_dir=%work_dir%\%pkg_name%
set build_dir=%src_dir%\GB28181Device
set install_dir=D:\Library\gb28181\device
...
mkdir %install_dir%
copy %build_dir%\%dir_platform%\Release\*.exe %install_dir%
copy %build_dir%\config.xml %install_dir%
copy %build_dir%\test.mp4 %install_dir%
