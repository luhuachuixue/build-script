...
cd /D %src_dir%\kstool
powershell -Command "(gc CMakeLists.txt) -replace 'kstool kstool.cpp', 'kstool getopt.cpp kstool.cpp' | Out-File -Encoding UTF8 CMakeLists.txt"

cd /D %src_dir%
cmake -G"MinGW Makefiles" -S. -B%build_dir% -DCMAKE_INSTALL_PREFIX=%install_dir% ^
    -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DKEYSTONE_BUILD_STATIC_RUNTIME=ON
